  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        with a passion for software innovation and cloud computing. At{" "}
        <span className="highlight">SAP</span>, as an
        ...
        and troubleshooting of virtual Linux machines. During my tenure at
        ...
        interfaces from the ground up. I'm now seeking a{" "}
